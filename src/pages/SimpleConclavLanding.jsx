...
const translations = {
  ...
  description: "Créez vos propres micro-réseaux de confiance en quelques minutes — avec une confidentialité totale. Aucun traçage. Aucune pub. Aucune Big Tech.",
  ...
  step2Description: "Envoyez des invitations par e-mail ou partagez un lien. Vous contrôlez qui entre et ce qui est partagé — rien ne devient public sans votre accord.",
  ...
  noTracking: "Aucun Google. Aucun Meta. Aucun Amazon. Aucun Apple. Aucun Microsoft — jamais derrière vous.",
  ...
  yourNetworksDesc: "Créez des communautés privées illimitées. Vous possédez votre espace, votre contenu et vos membres.",

  everythingYouNeed: "Tout ce dont vous avez besoin — rien de superflu.",
  simpleSecure: "Simple et sécurisé",
  simpleSecureDesc: "Créez vos réseaux en quelques secondes. Partagez, organisez, discutez — avec une sécurité de niveau bancaire et zéro surveillance d’entreprise.",
  europeanAlternative: "Conçu pour l’Europe",
  europeanAlternativeDesc: "Développé et hébergé en Europe — une véritable alternative aux plateformes de la Silicon Valley qui respectent votre indépendance numérique.",
