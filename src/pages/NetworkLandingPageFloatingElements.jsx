...
const NetworkLandingPageFloatingElementsWrapper = () => {
  ...
  if (networkId) {
    ...
    return (
      <NetworkProviderWithParams>
        <NetworkLandingPageFloatingElements />
      </NetworkProviderWithParams>
    );
  } else {
...
function NetworkLandingPageFloatingElements() {
  const { user } = useAuth();
      ...
      {network && (
        <Box sx={{
          ...
          '&::before': {
            ...
            //   : 'linear-gradient(180deg, rgba(255, 255, 255, 0.05) 0%, rgba(255, 255, 255, 0.1) 70%, rgba(255, 255, 255, 0.05) 100%)',
            zIndex: 1
          },
          '& > *': {
            position: 'relative',
...
export default NetworkLandingPageFloatingElementsWrapper;